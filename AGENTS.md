...
| [`src/components/ParentInputCard.tsx`](file:///workspaces/wechselmodell-rechner/src/components/ParentInputCard.tsx)                       | Parent configuration card (income, pension, occupational expenses, Eigenheim, debts, direct expenses).        |
...
| [`src/components/AuditTrailList.tsx`](file:///workspaces/wechselmodell-rechner/src/components/AuditTrailList.tsx)                         | Step-by-step audit log with mathematical formulas, BGH paragraphs, and previous/next step-by-step navigation. |
