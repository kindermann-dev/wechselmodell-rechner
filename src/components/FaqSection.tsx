...
const FAQ_DATA: FaqItem[] = [
  ...
  },
  {
    ...
    answer:
      "Das staatliche Kindergeld (2026: 259 € monatlich pro Kind) wird nach dem Grundsatzbeschluss des BGH vom 20. April 2016 (Az. XII ZB 45/15) und § 1612b BGB zweistufig aufgeteilt: 1. Ein 50 %-iger Betreuungsanteil steht beiden Elternteilen zu gleichen Teilen zu (je 25 % des gesamten Kindergeldes = 64,75 € fix und einkommensunabhängig als Betreuungsausgleich). 2. Der verbleibende 50 %-ige Baranteil (129,50 €) mindert den kindlichen Barbedarf und wird nach den individuellen Haftungsquoten (Q_A : Q_B) verrechnet. Jeder Elternteil hat Anspruch auf seinen 25 %-igen Betreuungsanteil plus eigene Barunterhaltsentlastung in Höhe seiner eigenen Haftungsquote (25 % KG + Q_eigen x 50 % KG). Der Auszahlungsempfänger leitet diesen Anspruch an den Nicht-Bezieher weiter: ΔKG_Bezieher = +(25 % KG + Q_Nicht-Bezieher x 50 % KG) bzw. ΔKG_Nicht-Bezieher = -(25 % KG + Q_eigen x 50 % KG). Liegen keine Einkommensnachweise vor, besteht stets ein sofortiger isolierter Mindestanspruch auf Auszahlung von 25 % des Kindergeldes („Ein-Viertel-Regel“).",
    legalBasis: "§ 1612b BGB, BGH XII ZB 45/15",
  },
  {
    id: "wohnmehrbedarf",
    question:
      "Was ist der Wohnmehrbedarf und wie wird er im Wechselmodell berechnet (BGH XII ZB 565/15 Rn. 35)?",
    answer:
      "Der in den Richtsätzen der Düsseldorfer Tabelle einkalkulierte Wohnkostenanteil von pauschal 20 % bildet lediglich den typisierten Bedarf für ein einziges Kinderzimmer im traditionellen Residenzmodell ab. Im echten 50:50-Wechselmodell müssen jedoch beide Elternteile vollwertigen Wohnraum für das Kind vorhalten. Nach der Leitentscheidung des Bundesgerichtshofs (BGH XII ZB 565/15 Rn. 35) stellt der über die 20 %-Tabellenpauschale hinausgehende Wohnaufwand beider Eltern einen unterhaltsrechtlichen Mehrbedarf dar. In diesem Rechner stehen Ihnen drei Optionen zur Verfügung: 1. Kein Wohnmehrbedarf (Standard): Berechnung rein nach Düsseldorfer Tabelle ohne zusätzlichen Wohnaufschlag. 2. Methode 1 (Pauschal nach Haushaltsgröße / Kopfzahl): Aufteilung der Warmmieten beider Eltern nach Kopfzahl – mit dem rechtlichen Hinweis, dass diese vereinfachte Methode von Familiengerichten in der Regel nicht anerkannt wird. 3. Methode 2 (Konkrete Wohnkosten pro Kind / Quadratmeter-Methode, gerichtlich anerkannt): Ermittlung der tatsächlichen Mehrkosten nach der Quadratmetermiete (Warmmiete ÷ Gesamtwohnfläche) multipliziert mit der dem Kind zuzuordnenden Wohnfläche (Kinderzimmer + anteilige Gemeinschaftsfläche). Werden konkrete Wohnkosten angesetzt, werden die tatsächlichen Kindes-Wohnkosten beider Haushalte vorab vom Gesamtbedarf abgezogen, der verbleibende Restbedarf für den laufenden Lebensunterhalt wird zu 50 % als Naturalunterhalt erbracht und jeder Elternteil bringt seine eigenen Kindes-Wohnkosten bedarfsmindernd in Abzug.",
    legalBasis:
